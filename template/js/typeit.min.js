    ...
    return function(t) {
        ...
        var i = {
          ...
          , r = function() {
            ...
            this.add = function(e) {
                ...
                return Array.isArray(e[0]) ? (t.waiting = t.waiting.concat(e),
                t) : (t.waiting[n ? "unshift" : "push"](e),
                t)
            }
            ,
            this.delete = function(e) {
                return t.waiting.splice(e, 1),
                t
            }
            ,
            this.reset = function() {
                return t.waiting = t.executed.concat(t.waiting),
                t.executed = [],
                t
            }
            ,
        ...
        var h = function(t, e) {
            ...
            if (a(t))
                ...
                if (i = i.length ? i[0] : null,
                "object" === p(e) && !(e instanceof HTMLElement)) {
                    ...
                    if (s && function(t, e) {
                        ...
                        for (var n = !1, i = [], r = t; !n; )
                            i.push(l(r, e)),
                            (r = r.parentNode) && !r.hasAttribute("data-typeit-id") || (n = !0);
                ...
                n = "object" === p(n) ? n : document.createTextNode(n),
                t.insertBefore(n, i && t.hasAttribute("data-typeit-id") ? i : null)
            }
        }
          , d = function(t) {
            var e = [];
          ...
          , S = function t(e) {
            var n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]
              , i = e.map((function(t) {
                if (b(t)) {
                    if (!n)
                        return f(t.childNodes);
                    for (var e = t.parentNode, i = [t.tagName]; ["BODY", "HTML"].indexOf(e.tagName) < 0; )
                        i.push(e.tagName),
                        e = e.parentNode;
                    return g(t, i)
                }
        ...
        function E() {
            var t = this
              ...
              , N = function(e) {
                ...
                t.queue.insert(e, [t.pause, i.before]),
                t.queue.insert(e + n + 1, [t.pause, i.after])
            };
            ...
            this.init = function() {
                ...
                if (!this.status.started) {
                    if (!O && t.opts.cursor && (s("@keyframes blink-".concat(l, " { 0% {opacity: 0} 49% {opacity: 0} 50% {opacity: 1} }[data-typeit-id='").concat(l, "'] .ti-cursor { animation: blink-").concat(l, " ").concat(t.opts.cursorSpeed / 1e3, "s infinite; }"), l),
                ...
                for (var e = this, i = this.queue.waiting.slice(), r = Promise.resolve(), o = function(t) {
                    ...
                    r = r.then((function() {
                        return new Promise((function(t, n) {
                            ...
                            if (e.status.frozen)
                                return n();
                            (e.pace = $(e.opts.speed, e.opts.deleteSpeed, e.opts.lifeLike),
                            o[2] && o[2].isFirst) && (r = e.opts).beforeString.apply(r, u);
                            (i = e.opts).beforeStep.apply(i, u),
                            o[0].call(e, o[1], o[2]).then((function() {
                                var n, i, r = e.queue.waiting.shift();
                                if (o[2] && o[2].isPhantom)
                                    return t();
                                o[2] && o[2].isLast && (i = e.opts).afterString.apply(i, u);
                                return (n = e.opts).afterStep.apply(n, u),
                                e.queue.executed.push(r),
                                t()
                            }
                            ))
                        }
            ...
            this.delete = function() {
                ...
                return new Promise((function(n) {
                    t.wait((function() {
                        var i = b();
                        return i.length && A(i[i.length - 1]),
                        M(t.$e),
                        e && i.length - 1 > 0 ? t.delete(!0).then((function() {
                            return n()
                        }
                        )) : n()
                    }
            ...
            this.setOptions = function(t) {
                var e = this;
                return new Promise((function(n) {
                    return e.opts = Object.assign({}, e.opts, t),
                    n()
                }
                ))
            }
            ...
            P = function(e) {
                var n = t.$e.innerHTML;
                return n ? (t.$e.innerHTML = "",
                t.opts.startDelete ? (w(n).forEach((function(e) {
                    h(t.$e, e)
                }
                )),
            ...
            this.opts.strings.length && !g && t.opts.strings.forEach((function(e, n) {
                ...
                if (n + 1 !== t.opts.strings.length) {
                    if (t.opts.breakLines)
                        return t.queue.add([t.type, o("BR")]),
                        void N(r);
                    t.queue.add(T(i, t.delete)),
                    N(r, e.length)
                }
            }
            ))
        ...
        var O = function(t, e, n) {
          ...
          , P = function(t) {
            return "string" == typeof t ? t = document.querySelectorAll(t) : t.forEach || (t = [t]),
            f(t)
        };
        function C(t, e) {
            var n = this;
            ...
            this.unfreeze = function() {
                i((function(t) {
                    t.status.frozen && (t.status.frozen = !1,
                    t.fire())
                }
                ))
            }
            ...
            this.delete = function() {
                ...
                return r("delete", null === t, null === t ? 1 : t),
                this
            }
            ,
            this.pause = function() {
